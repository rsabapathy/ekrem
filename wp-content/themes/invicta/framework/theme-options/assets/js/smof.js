...
jQuery(document).ready(function($){
	...
	function GoogleFontSelect( slctr, mainID ){
		...
		var _is_google_web_font = false;
		
		for (var i=0; i<invicta_fonts.google_web_fonts.length; i++) {
			if (_selected == invicta_fonts.google_web_fonts[i]) {
				_is_google_web_font = true;
			}
		}
