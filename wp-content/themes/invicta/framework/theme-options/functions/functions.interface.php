...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( THEMENAME, $label, 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function of_load_only() 
{
	...
	/* INVICTA Customization [Begin] */
	$google_fonts = invicta_get_google_web_fonts();
	$native_fonts = invicta_get_os_native_fonts();
	$params = array(
	  'google_web_fonts' => $google_fonts,
	  'os_native_fonts' => $native_fonts,
	);
	wp_localize_script( 'smof', 'invicta_fonts', $params );
	/* INVICTA Customization [End] */
