...
class Options_Machine {
		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup :', 'invicta_dictionary').' <span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
					$output .= '<a href="#" id="of_backup_button" class="button" title="Backup Options">' . __( 'Backup Options', 'invicta_dictionary') . '</a>';
					$output .= '<a href="#" id="of_restore_button" class="button" title="Restore Options">' . __( 'Restore Options', 'invicta_dictionary') . '</a>';
					$output .= '</div>';
				...
				case 'transfer':
					...
					$output .= '<a href="#" id="of_import_button" class="button" title="Restore Options">' . __( 'Import Options', 'invicta_dictionary' ) . '</a>';
	...
	public static function optionsframework_media_uploader_function($id,$std,$mod){
		...
		if ( function_exists( 'wp_enqueue_media' ) ) {
			$uploader .= '<span class="button media_upload_button" id="'.$id.'">' . __( 'Upload', 'invicta_dictionary' ) . '</span>';
